...
export const content: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('../../areas/cooperative/sub-categories/sub-categories.module').then(m => m.SubCategoriesModule),
    data: {
  ...
  },
  {
    ...
    loadChildren: () => import('../../areas/cooperative/categories/categories.module').then(m => m.CategoriesModule),
    data: {
  ...
  },
  {
    ...
    loadChildren: () => import('../../areas/cooperative/product/product-routing.module').then(m => m.ProductRoutingModule),
    data: {
      breadcrumb: "Categories"
    }
  }
