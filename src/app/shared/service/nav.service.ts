...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      active: false,
      children: [
        { path: '/management/products', title: 'Products', type: 'link' },
        { path: '/management/categories', title: 'Categories', type: 'link'},
        { path: '/management/sub-categories', title: 'Sub Categories', type: 'link' },
      ],
    },
    {
      title: 'Products',
